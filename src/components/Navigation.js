    ...
    <div className={isOpen === true ? styles.show_nav : styles.hide_nav}>
      <div className={styles.navigation} style={mode === 'light' ? {backgroundColor: '#fff'} : {backgroundColor: '#2F3146'}}>
        ...
        <div className={lists === 2 ? styles.list : null} to="" onClick={() => setLists(2)}>
          ...
          <ul className={mode === 'light' ? styles.light_ul : styles.dark_ul}>  
            <Link className={page === 6 ? mode === 'light' ? styles.light_checked : styles.dark_checked : null} to="" onClick={() => onChangePage(6)}><li><p>통계분석</p></li></Link>
            <Link className={page === 7 ? mode === 'light' ? styles.light_checked : styles.dark_checked : null} to="" onClick={() => onChangePage(7)}><li><p>계정관리</p></li></Link>
            <Link className={page === 8 ? mode === 'light' ? styles.light_checked : styles.dark_checked : null} to="" onClick={() => onChangePage(8)}><li><p>점수 영역관리</p></li></Link>
            <Link className={page === 9 ? mode === 'light' ? styles.light_checked : styles.dark_checked : null} to="" onClick={() => onChangePage(9)}><li><p>학생 등록</p></li></Link>
          </ul>
        </div>
        </div>
