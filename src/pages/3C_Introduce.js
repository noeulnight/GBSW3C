    ...
    style={
      ...
      <div className={styles.main}>
        ...
        <div className={styles.information}>
          ...
          <a target="_blank" href="https://3c-uploaded.s3.ap-northeast-2.amazonaws.com/files/2022%EB%85%84+3C%EC%9D%B8%EC%A6%9D%EC%A0%9C+%EA%B8%B0%EC%A4%80.pdf" style={mode === 'light' ? {color: '#0320b1'} : {color: '#0684c4'}} >자세한 내용은 이곳을 눌러 확인하세요</a>
          {/* 대충 설치 위치 */}
        </div>
      </div>
    </div>
